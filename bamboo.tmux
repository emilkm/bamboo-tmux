...
main() {
  ...
  custom_path="$(get_tmux_option "@bamboo_custom_plugin_dir" "${PLUGIN_DIR}/custom")"
  ...
  status_default=$(get_tmux_option "@bamboo_status_default" "on")
  # shellcheck disable=SC2121
  set status "$status_default"

  status_justify=$(get_tmux_option "@bamboo_status_justify" "left")
  set status-justify "$status_justify"

  status_background=$(get_tmux_option "@bamboo_status_background" "theme")
  ...
  pane_status_enable=$(get_tmux_option "@bamboo_pane_status_enabled" "no") # yes
  pane_border_status=$(get_tmux_option "@bamboo_pane_border_status" "off") # bottom
  pane_border_style=$(get_tmux_option "@bamboo_pane_border_style" "fg=${thm_gray}")
  ...
  pane_left_separator=$(get_tmux_option "@bamboo_pane_left_separator" "█")
  pane_middle_separator=$(get_tmux_option "@bamboo_pane_middle_separator" "█")
  pane_right_separator=$(get_tmux_option "@bamboo_pane_right_separator" "█")
  pane_number_position=$(get_tmux_option "@bamboo_pane_number_position" "left") # right, left
  ...
  window_status_separator=$(get_tmux_option "@bamboo_window_separator" "")
  setw window-status-separator "$window_status_separator"

  window_left_separator=$(get_tmux_option "@bamboo_window_left_separator" "█")
  window_right_separator=$(get_tmux_option "@bamboo_window_right_separator" "█")
  window_middle_separator=$(get_tmux_option "@bamboo_window_middle_separator" "█ ")
  window_number_position=$(get_tmux_option "@bamboo_window_number_position" "left") # right, left
  window_status_enable=$(get_tmux_option "@bamboo_window_status_enable" "no")       # right, left
  ...
  status_left_separator=$(get_tmux_option "@bamboo_status_left_separator" "")
  status_right_separator=$(get_tmux_option "@bamboo_status_right_separator" "█")
  status_connect_separator=$(get_tmux_option "@bamboo_status_connect_separator" "yes")
  status_fill=$(get_tmux_option "@bamboo_status_fill" "icon")

  status_modules_left=$(get_tmux_option "@bamboo_status_modules_left" "")
  ...
  status_modules_right=$(get_tmux_option "@bamboo_status_modules_right" "application session")
