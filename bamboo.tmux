...
build_window_icon() {
  local window_status_icon_enable=$(get_tmux_option "@bamboo_window_status_icon_enable" "yes")
  local custom_icon_window_last=$(get_tmux_option "@bamboo_icon_window_last" "󰖰 ")
  local custom_icon_window_current=$(get_tmux_option "@bamboo_icon_window_current" "󰖯 ")
  local custom_icon_window_zoom=$(get_tmux_option "@bamboo_icon_window_zoom" "󰁌 ")
  local custom_icon_window_mark=$(get_tmux_option "@bamboo_icon_window_mark" "󰃀 ")
  local custom_icon_window_silent=$(get_tmux_option "@bamboo_icon_window_silent" "󰂛 ")
  local custom_icon_window_activity=$(get_tmux_option "@bamboo_icon_window_activity" "󱅫 ")
  local custom_icon_window_bell=$(get_tmux_option "@bamboo_icon_window_bell" "󰂞 ")
...
main() {
  ...
  while IFS='=' read -r key val; do
      ...
      eval "local $key"="$val"
  done < "${PLUGIN_DIR}/bamboo-${theme}.tmuxtheme"

  # module directories
  local custom_path="$(get_tmux_option "@bamboo_custom_plugin_dir" "${PLUGIN_DIR}/custom")"
  ...
  # status
  local status_default=$(get_tmux_option "@bamboo_status_default" "on")
  local status_justify=$(get_tmux_option "@bamboo_status_justify" "left")
  ...
  # panes
  local pane_status_enable=$(get_tmux_option "@bamboo_pane_status_enabled" "no") # yes
  local pane_border_status=$(get_tmux_option "@bamboo_pane_border_status" "off") # bottom
  local pane_border_style=$(get_tmux_option "@bamboo_pane_border_style" "fg=${thm_gray}")
  local pane_active_border_style=$(\
    get_tmux_option "@bamboo_pane_active_border_style" \
    "#{?pane_in_mode,fg=${thm_yellow},#{?pane_synchronized,fg=${thm_magenta},fg=${thm_orange}}}"
  )
  local pane_left_separator=$(get_tmux_option "@bamboo_pane_left_separator" "█")
  local pane_middle_separator=$(get_tmux_option "@bamboo_pane_middle_separator" "█")
  local pane_right_separator=$(get_tmux_option "@bamboo_pane_right_separator" "█")
  local pane_number_position=$(get_tmux_option "@bamboo_pane_number_position" "left") # right, left
  ...
  local window_left_separator=$(get_tmux_option "@bamboo_window_left_separator" "█")
  local window_right_separator=$(get_tmux_option "@bamboo_window_right_separator" "█")
  local window_middle_separator=$(get_tmux_option "@bamboo_window_middle_separator" "█ ")
  local window_number_position=$(get_tmux_option "@bamboo_window_number_position" "left") # right, left
  local window_status_enable=$(get_tmux_option "@bamboo_window_status_enable" "no") # right, left
  ...
  local status_left_separator=$(get_tmux_option "@bamboo_status_left_separator" "")
  local status_right_separator=$(get_tmux_option "@bamboo_status_right_separator" "█")
  local status_right_separator_inverse=$(get_tmux_option "@bamboo_status_right_separator_inverse" "no")
  local status_connect_separator=$(get_tmux_option "@bamboo_status_connect_separator" "yes")
  local status_fill=$(get_tmux_option "@bamboo_status_fill" "icon")

  local status_modules_right=$(get_tmux_option "@bamboo_status_modules_right" "application session")
  local loaded_modules_right=$(load_modules "$status_modules_right" "$modules_custom_path" "$modules_status_path")

  local status_modules_left=$(get_tmux_option "@bamboo_status_modules_left" "")
